 ...
 * - Export button creates a formatted PDF.
...
export default function ReviewSummaryPage() {
  ...
  const onExportPdf = () => {
    ...
    const addSection = (title: string, body: string) => {
      ...
      doc.setFontSize(11);
      const safeBody = body?.trim() ? body.trim() : "(No content)";
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(20);
    doc.text("Review & Summary", margin, y);
    y += 22;
    ...
    addSection("Your Explanation", explanation);
    addSection("Your Analogy", analogy);
    ...
    doc.text("Generated with AdaptEd (Feynman Technique)", margin, y);
    doc.setTextColor(0);

    doc.save(`${sanitize(topic)}-summary.pdf`);
  };
